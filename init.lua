...
-- Disable netrw (use Telescope for file navigation instead)
...
-- Default indentation (used when guess-indent can't determine from file)
vim.o.tabstop = 4
vim.o.shiftwidth = 4
vim.o.softtabstop = 4
...
-- Trust project-local .nvim.lua files (for per-repo editor settings)
vim.o.exrc = true
...
-- Alternative arrow key bindings for window navigation (Ctrl+Arrow)
...
require('lazy').setup({
  ...
  { -- Fuzzy Finder (files, lsp, etc)
    ...
    config = function()
      ...
      vim.keymap.set('n', '<leader>so', builtin.oldfiles, { desc = '[S]earch [O]ld (Recent) Files' })
  ...
  -- LSP Plugins
  {
    ...
    config = function()
      ...
      -- Set up ruby_lsp manually (not managed by Mason, using rbenv)
  ...
  { -- Highlight, edit, and navigate code
    ...
    config = function()
      ...
      local parsers = { 'bash', 'c', 'diff', 'go', 'html', 'lua', 'luadoc', 'markdown', 'markdown_inline', 'python', 'query', 'ruby', 'vim', 'vimdoc', 'toml' }
